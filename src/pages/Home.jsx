  ...
  return (
    <section
      style={{
        ...
        background: 'radial-gradient(circle at 30% 30%, rgba(0,255,200,0.06), transparent 80%)',
        color: '#fff',
      }}
    >
      <style>
        ...
        >
          ...
          <motion.div
            ...
            style={{
              ...
              width: '300px',
              height: '300px',
              boxShadow: '0 0 45px rgba(0,255,200,0.18)',
        ...
        >
          ...
          >
            {[
              ...
              { label: 'Expertise', value: 'MERN, Python, Web & Data' },
              ...
              <motion.div
                ...
                style={{
                  ...
                  minWidth: '180px',
                  textAlign: 'center',
                  boxShadow: '0 0 10px rgba(0,255,200,0.06)',
                }}
              >
      ...
      >
        <h2 style={{ fontSize: '1.2rem', marginBottom: '0.5rem' }}>Connect</h2>
        <div
          style={{
            display: 'flex',
            flexWrap: 'wrap',
